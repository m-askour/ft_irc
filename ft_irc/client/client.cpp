...
{
    return is_authenticated;//this is if the password is correct 
}

bool client::is_registered_client() const
{
    return is_registered;//this is if the client has completed the registration process (e.g., sent NICK and USER commands)
}
