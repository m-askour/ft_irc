...
public:
    ...
    ///this check the information about the chanell and what's the permision have this client in this chanell
    bool check_client_info() const;
    void print_client_info() const;
    //chekc if the client is in chanell

    //check if the client is remove from chanell
};
